...
h5d_file_path = "./Model/model_regression.h5"
label_data = pd.read_csv("./A549/Data/A549_RNAseq_regression.txt", delimiter="\t")
with h5py.File('./Data/h5file/epi_data.h5', 'r') as hf:
    epigenetics_input_data = hf['dataset_1'][:]

with h5py.File('./Data/h5file/seq_data.h5', 'r') as hf:
...
random_oder_path = "./Model/random_order_path.txt"
...
f=open('./Model/promoter_hypersearching_value.txt','a')
...
h5f = h5py.File('./Data/h5file/epi_imp_DE.h5', 'w')
